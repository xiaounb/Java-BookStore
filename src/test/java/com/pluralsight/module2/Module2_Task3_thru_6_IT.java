...
public class Module2_Task3_thru_6_IT extends Mockito {
	...
	public void setUp() throws Exception {
		...
		when(request.getRequestDispatcher("/BookForm.jsp")).thenReturn(mockRequestDispatcher);
	...
	public void _task3() throws Exception {
		...
		String errorMsg = "In ControllerServlet showEditForm()," + " did not call getParameter(\"id\").";
		assertTrue(errorMsg, called_getParameter);
		errorMsg = "In ControllerServlet showEditForm()," + " did not call getBook(id).";
