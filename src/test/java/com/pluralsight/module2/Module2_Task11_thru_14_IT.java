...
public class Module2_Task11_thru_14_IT {
	...
	public void _task12() {
		...
		try {
			...
			assertTrue("Title field value is empty, value is \"" + titleValue + "\".", titleValue.length() > 0);
		} catch (ElementNotFoundException e) {
	...
	public void _task13() {
		...
		try {
			...
			assertTrue("Author field value is empty, value is \"" + authorValue + "\".", authorValue.length() > 0);
		} catch (ElementNotFoundException e) {
		...
		try {
			...
			assertTrue("Price field value is empty, value is \"" + priceValue + "\".", priceValue.length() > 0);
		} catch (ElementNotFoundException e) {
