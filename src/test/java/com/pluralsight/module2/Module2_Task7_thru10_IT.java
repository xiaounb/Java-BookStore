...
public class Module2_Task7_thru10_IT {
	...
	public void h2_correct(String urlStr) {
		...
		if (urlStr.equals("Edit"))
			list = editPage.getElementsByTagName("h2");
		else
			list = newPage.getElementsByTagName("h2");
		String h2Text = "";
		...
		String errorMsg = "The h2 tag in BookForm contains " + h2Text + " but we expected it to contain " + desiredText;
